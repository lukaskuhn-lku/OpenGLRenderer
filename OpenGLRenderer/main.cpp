...
int main() {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 1; i++)
        {
            ...
            float angle = (float)glfwGetTime() * rotationFactor;
        ...
        ImGui::SliderInt("Rotation", &rotationFactor, 0.0f, 100.0f);
        ImGui::DragFloat3("Location Box", pos, 0.1f);
